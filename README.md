...
> This is a brand new professional portfolio made from scratch taking advantage of React & Redux to show my future projects.
...
- [GitHub Deploy](https://jsug9.github.io/portfolio/).
...
2. Type the following commands into the terminal: 
 ```
 git clone https://github.com/jsug9/portfolio
 ```
 ```
 cd portfolio
 ```
